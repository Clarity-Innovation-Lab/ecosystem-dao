...
(define-public (execute (sender principal))
	(begin
		...
		(try! (contract-call? .ede008-funded-proposal-submission-v4 set-refundable .edp003-allowlist-escrow-nft true)) ;; signal from 3 out of 4 team members requied.
		(try! (contract-call? .ede008-funded-proposal-submission-v4 set-parameter "funding-cost" u1000000000)) 
