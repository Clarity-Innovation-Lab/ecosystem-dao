...
(define-public (execute (sender principal))
	(try! (contract-call? .ecosystem-dao set-extension .ede007-snapshot-proposal-voting-v4 true))
	(contract-call? .ecosystem-dao set-extension .ede008-funded-proposal-submission-v4 true)
)
