...
fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  assertProposal(false, false, 0, 200, (getDurations(2, ede002ProposalSubmissionClient).startHeight + 1), getDurations(2, ede002ProposalSubmissionClient).endHeight + 1, phil.address, contractEDP001, ede001ProposalVotingClient)
  assertProposal(false, false, 200, 0, (getDurations(2, ede002ProposalSubmissionClient).startHeight + 1), getDurations(2, ede002ProposalSubmissionClient).endHeight + 1, bobby.address, contractEDP003, ede001ProposalVotingClient)
  ...
  assertProposal(false, false, 500, 200, (getDurations(2, ede002ProposalSubmissionClient).startHeight + 1), getDurations(2, ede002ProposalSubmissionClient).endHeight + 1, phil.address, contractEDP001, ede001ProposalVotingClient)
  assertProposal(false, false, 700, 0, (getDurations(2, ede002ProposalSubmissionClient).startHeight + 1), getDurations(2, ede002ProposalSubmissionClient).endHeight + 1, bobby.address, contractEDP003, ede001ProposalVotingClient)
}
});
...
fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  assertProposal(false, false, 0, 0, (getDurations(2, ede002ProposalSubmissionClient).startHeight + 1), getDurations(2, ede002ProposalSubmissionClient).endHeight + 1, phil.address, contractEDP001, ede001ProposalVotingClient)
  block = chain.mineBlock([
  ...
  assertProposal(true, false, 0, 0, (getDurations(2, ede002ProposalSubmissionClient).startHeight + 1), getDurations(2, ede002ProposalSubmissionClient).endHeight + 1, phil.address, contractEDP001, ede001ProposalVotingClient)
}
});
...
fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  assertProposal(true, true, 100, 101, (getDurations(2, ede002ProposalSubmissionClient).startHeight + 1), getDurations(2, ede002ProposalSubmissionClient).endHeight + 1, phil.address, contractEDP001, ede001ProposalVotingClient)
  assertProposal(true, false, 101, 100, (getDurations(2, ede002ProposalSubmissionClient).startHeight + 1), getDurations(2, ede002ProposalSubmissionClient).endHeight + 1, phil.address, contractEDP003, ede001ProposalVotingClient)
}
});
...
fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  assertProposal(true, false, 500, 500, (getDurations(2, ede002ProposalSubmissionClient).startHeight + 1), getDurations(2, ede002ProposalSubmissionClient).endHeight + 1, phil.address, contractEDP001, ede001ProposalVotingClient)
}
});
...
fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  let startHeight = getDurations(0, ede002ProposalSubmissionClient).startHeight + 3
  let block = chain.mineBlock([
    exeDaoClient.construct(contractEDP000, deployer.address),
    ede002ProposalSubmissionClient.propose(contractEDP001, startHeight, contractEDE000, phil.address),
  ]);
  ...
  assertProposal(true, true, 0, 1000, (getDurations(2, ede002ProposalSubmissionClient).startHeight + 1), getDurations(2, ede002ProposalSubmissionClient).endHeight + 1, phil.address, contractEDP001, ede001ProposalVotingClient)
  assertProposal(false, false, 0, 0, 1888, 3328, phil.address, contractEDP002, ede001ProposalVotingClient)
  block = chain.mineBlock([
  ...
  assertProposal(true, true, 0, 1000, (getDurations(2, ede002ProposalSubmissionClient).startHeight + 1), getDurations(2, ede002ProposalSubmissionClient).endHeight + 1, phil.address, contractEDP001, ede001ProposalVotingClient)
  assertProposal(false, false, 0, 200, 1888, 3328, phil.address, contractEDP002, ede001ProposalVotingClient)
