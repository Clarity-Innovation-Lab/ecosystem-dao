...
Clarinet.test({
    ...
    fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      assertEquals(
        ...
        { 'user-balance': 'u100000000000000', 'voting-cap': 'u140000000000'}
      );
    }
  });
  ...
  Clarinet.test({
    ...
    fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      block = chain.mineBlock([
        ede007SnapshotProposalVotingClient.vote(140000000000, true, contractEDP004, daisy.address),
        ede007SnapshotProposalVotingClient.vote(130000000000, true, contractEDP004, phil.address),
      ]);
