...
import { EDE009GovernanceTokenSaleErrCode } from "./src/ede009-governance-token-sale-client.ts";
...
Clarinet.test({
  ...
  Clarinet.test({
    ...
    fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      ede009GovernanceTokenSaleClient.getTotalAllocation().result.expectUint(0)
    }
  });
  Clarinet.test({
    ...
    fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      const block = chain.mineBlock([
        ...
        ede009GovernanceTokenSaleClient.refund(daisy.address),
        ede009GovernanceTokenSaleClient.claim(daisy.address),
      ]);
      block.receipts[0].result.expectErr().expectUint(EDE009GovernanceTokenSaleErrCode.err_sale_ended)
      block.receipts[1].result.expectErr().expectUint(EDE009GovernanceTokenSaleErrCode.err_sale_succeeded)
      block.receipts[2].result.expectErr().expectUint(EDE009GovernanceTokenSaleErrCode.err_nothing_to_claim)
    }
  });
  Clarinet.test({
    ...
    fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      const block = chain.mineBlock([
        ...
        ede009GovernanceTokenSaleClient.buy(1000, ward.address)
      ]);
      block.receipts[0].result.expectOk().expectBool(true)
      block.receipts[1].result.expectOk().expectBool(true)
      ede000GovernanceTokenClient.edgGetBalance(ward.address).result.expectOk().expectUint(0)
      ede009GovernanceTokenSaleClient.getUnclaimedAllocation(ward.address).result.expectUint(1000)
      ede009GovernanceTokenSaleClient.getTotalAllocation().result.expectUint(1000)
    }
  });
  Clarinet.test({
    ...
    fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      block.receipts[0].result.expectOk().expectBool(true)
      block.receipts[1].result.expectOk().expectBool(true)
      block.receipts[2].result.expectErr().expectUint(EDE009GovernanceTokenSaleErrCode.err_sale_not_ended)
    }
  });
  Clarinet.test({
    ...
    fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      ede009GovernanceTokenSaleClient.getUnclaimedAllocation(ward.address).result.expectUint(0)
      ede009GovernanceTokenSaleClient.getUnclaimedAllocation(daisy.address).result.expectUint(1000)
      ede009GovernanceTokenSaleClient.getTotalAllocation().result.expectUint(1000)
    }
  });
  Clarinet.test({
    ...
    fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      ede000GovernanceTokenClient.edgGetBalance(ward.address).result.expectOk().expectUint(0)
      ede000GovernanceTokenClient.edgGetBalance(daisy.address).result.expectOk().expectUint(1000)
      ede009GovernanceTokenSaleClient.getUnclaimedAllocation(ward.address).result.expectUint(2000)
      ede009GovernanceTokenSaleClient.getUnclaimedAllocation(daisy.address).result.expectUint(2000)
      ede009GovernanceTokenSaleClient.getTotalAllocation().result.expectUint(4000)
    }
  });
  ...
  Clarinet.test({
    ...
    fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      block.receipts[0].result.expectErr().expectUint(EDE009GovernanceTokenSaleErrCode.err_sale_already_started)
      block.receipts[1].result.expectErr().expectUint(EDE009GovernanceTokenSaleErrCode.err_sale_ended)
      block.receipts[2].result.expectErr().expectUint(EDE009GovernanceTokenSaleErrCode.err_sale_ended)

      ede000GovernanceTokenClient.edgGetBalance(ward.address).result.expectOk().expectUint(0)
      ede000GovernanceTokenClient.edgGetBalance(daisy.address).result.expectOk().expectUint(1000)
      ede009GovernanceTokenSaleClient.getUnclaimedAllocation(ward.address).result.expectUint(1000)
      ede009GovernanceTokenSaleClient.getUnclaimedAllocation(daisy.address).result.expectUint(1000)
      ede009GovernanceTokenSaleClient.getTotalAllocation().result.expectUint(2000)
    }
  });
  Clarinet.test({
  ...
  Clarinet.test({
    ...
    fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      block = chain.mineBlock([
        ede009GovernanceTokenSaleClient.start(daisy.address),
        ede009GovernanceTokenSaleClient.claim(daisy.address),
        ede009GovernanceTokenSaleClient.claim(ward.address),
      ]);
      block.receipts[0].result.expectErr().expectUint(EDE009GovernanceTokenSaleErrCode.err_sale_already_started)
      block.receipts[1].result.expectOk().expectBool(true)
      block.receipts[2].result.expectOk().expectBool(true)
  ...
  Clarinet.test({
    ...
    fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      let block = chain.mineBlock([
        ede009GovernanceTokenSaleClient.start(daisy.address),
        ede009GovernanceTokenSaleClient.buy(1000, daisy.address),
        ede009GovernanceTokenSaleClient.buy(1000, bobby.address),
        ede009GovernanceTokenSaleClient.buy(999, ward.address),
      ]);
      block.receipts[0].result.expectOk().expectBool(true)
      block.receipts[1].result.expectOk().expectBool(true)
      block.receipts[2].result.expectOk().expectBool(true)
      ...
      block.receipts[0].result.expectOk().expectBool(true)
      block.receipts[1].result.expectErr().expectUint(EDE009GovernanceTokenSaleErrCode.err_sale_failed)
  ...
  Clarinet.test({
    ...
    fn(chain: Chain, accounts: Map<string, Account>) {
      ...
      block = chain.mineBlock([
        ede009GovernanceTokenSaleClient.refund(daisy.address),
        ede009GovernanceTokenSaleClient.claim(daisy.address),
        ede009GovernanceTokenSaleClient.claim(bobby.address),
        ede009GovernanceTokenSaleClient.claim(ward.address),
      ]);
      block.receipts[0].result.expectErr().expectUint(EDE009GovernanceTokenSaleErrCode.err_sale_succeeded)
      block.receipts[1].result.expectOk().expectBool(true)
      block.receipts[2].result.expectOk().expectBool(true)
      block.receipts[2].result.expectOk().expectBool(true)
      ...
      ede009GovernanceTokenSaleClient.getUnclaimedAllocation(ward.address).result.expectUint(0)
      ede009GovernanceTokenSaleClient.getUnclaimedAllocation(daisy.address).result.expectUint(0)
      ede009GovernanceTokenSaleClient.getUnclaimedAllocation(bobby.address).result.expectUint(0)
      ede009GovernanceTokenSaleClient.getTotalAllocation().result.expectUint(2999)
    }
  });
