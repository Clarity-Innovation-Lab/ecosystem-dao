...
(define-public (execute (sender principal))
	(begin
		...
		(try! (contract-call? .ede002-threshold-proposal-submission set-governance-token .ede000-governance-token-v2))
		(try! (contract-call? .ede002-threshold-proposal-submission set-parameter "minimum-proposal-start-delay" u288))
