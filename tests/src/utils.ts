...
export class Utils {
  ...
  setup = (chain: Chain, accounts: Map<string, Account>): {
    ...
    const contractEDE007 = accounts.get("deployer")!.address + '.ede007-snapshot-proposal-voting-v5';
    const contractEDE008 = accounts.get("deployer")!.address + '.ede008-funded-proposal-submission-v5';
    ...
    const ede007SnapshotProposalVotingClient = new EDE007SnapshotProposalVotingClient(chain, deployer, 'ede007-snapshot-proposal-voting-v5');
    const ede008FundedProposalSubmissionClient = new EDE008FundedProposalSubmissionClient(chain, deployer, 'ede008-funded-proposal-submission-v5');
